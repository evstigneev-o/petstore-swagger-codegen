...
import petstore.auth.HttpBasicAuth;
import petstore.auth.ApiKeyAuth;
import petstore.auth.OAuth;
import petstore.auth.OAuth.AccessTokenListener;
import petstore.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "http://petstore.swagger.io/v1";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
